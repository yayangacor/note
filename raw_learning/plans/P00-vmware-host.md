# P00 — Host VMware Workstation → Proxmox nested

**Status:** ❌ belum mulai · **Dependency:** — · **Blokir:** tidak ada
**Berlaku di:** ketiga PC lab, dikerjakan identik · **Serah terima ke:** [[P01]]
...
retention 2–3** ([[Q-03]]). Backup yang kehabisan ruang gagal diam-diam dan baru ketahuan saat
dibutuhkan.
...
## 3. Rencana alamat — ini juga jawaban sebagian untuk [[Q-02]]
...
- [ ] Blok 31+ alamat sudah disepakati dengan anggota jaringan dan ditulis di `NOTES.md` [[Q-02]]
